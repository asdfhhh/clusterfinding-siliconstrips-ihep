// Cluster_Finding_Raw_data_out.cpp : 定义应用程序的类行为。
//
...
// CCluster_Finding_Raw_data_outApp 构造
...
// 唯一的一个 CCluster_Finding_Raw_data_outApp 对象

CCluster_Finding_Raw_data_outApp theApp;


// CCluster_Finding_Raw_data_outApp 初始化
