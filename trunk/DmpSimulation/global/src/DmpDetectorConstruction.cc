   ...
   solidBGO(0),logicBGO(0),physiBGO(0)
{
  ...
  dmpPsdDetectorDescription = new DmpPsdDetectorDescription();
  dmpStkDetectorDescription = new DmpStkDetectorDescription();
  dmpBgoDetectorDescription = new DmpBgoDetectorDescription();
...
void DmpDetectorConstruction::DefineMaterials()
{ 
  ...
  G4cout << "DmpDetectorConstruction::DefineMaterials: dump material defined " << G4endl;
...
G4VPhysicalVolume* DmpDetectorConstruction::ConstructPayload()
{
